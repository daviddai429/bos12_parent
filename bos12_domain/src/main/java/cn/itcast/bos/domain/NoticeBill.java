...
public class NoticeBill implements java.io.Serializable {
	...
	private Integer num;//取件数量
	private Double weight;//重量
	private String volume;//体积
	private String remark;//备注
	private String ordertype;//分单类型 1：自动分单 2：手动分单
	private Set workBills = new HashSet(0);//工单
    
	/**
	 * 手动分单
	 */
	public static final String ORDERTYPE_MAN = "2";
	/**
	 * 自动分单
	 */
    public static final String ORDERTYPE_AUTO = "1";
