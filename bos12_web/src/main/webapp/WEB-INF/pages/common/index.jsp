...
<script type="text/javascript">
	...
	$(function() {
		...
		// 基本功能菜单加载
		$.ajax({
			url : '${pageContext.request.contextPath}/functionAction_findMenuByUserId.action',
			type : 'POST',
			dataType : 'text',
		...
		$("#btnEp").click(function(){
			...
			if(v){
				...
				if(txtNewPass == txtRePass){
					...
					$.post(url,{"password":txtNewPass},function(data){
						if(data == 1){
							//1=成功 提示修改密码成功
...
<body class="easyui-layout">
    ...
    <div id="editPwdWindow" class="easyui-window" title="修改密码" collapsible="false" minimizable="false" modal="true" closed="true" resizable="false"
        ...
        background: #fafafa">
        <div id="editForm" class="easyui-layout" fit="true">
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input class="easyui-validatebox" data-options="required:true,validType:'length[5,12]'"  id="txtNewPass" type="Password" class="txt01" /></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td><input class="easyui-validatebox"  data-options="required:true,validType:'length[5,12]'"  id="txtRePass" type="Password" class="txt01" /></td>
                    </tr>
                </table>
            </div>
