				...
				<tr>
	           	...
	           	<tr>
           			...
           			<td colspan="3" id="roleTD"> 
           						<!-- <input id="role1" type="checkbox" value="1"><label for="role1">取派员</label>   &nbsp;
           					    <input id="role2" type="checkbox" value="2"><label for="role2">业务人员</label> -->
           					    <script type="text/javascript">
           					    	$(function(){
           					    		//页面加载完成，动态查询角色数据
           					    		...
           					    		$.post(url,{},function(data){
           					    			...
           					    			for (var i = 0; i < data.length; i++) {
           					    				var id = data[i].id;//角色id
           					    				var name = data[i].name;//角色名称
