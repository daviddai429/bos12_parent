...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#btn").click(function(){
			...
			/* var province = $("input[name=region.province]").val();*/
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="saveSubareaForm" action="${pageContext.request.contextPath }/subareaAction_save.action" method="post">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>选择区域</td>
						<td>
							<!-- name=region.id combobox自带中文模糊查询 mode:remote 从服务加载数据-->
							<input class="easyui-combobox" name="region.id"  
    							data-options="mode:'remote',valueField:'id',textField:'regionName',url:'${pageContext.request.contextPath}/regionAction_listajax.action'" />  
						</td>
					</tr>
					<tr>
						<td>关键字</td>
